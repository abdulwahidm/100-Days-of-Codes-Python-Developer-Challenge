"""The Note class (representation of a note) is given. Implement the Notebook class (representation of a notebook with notes) with two methods:
...
Then, using the new_note() method add two notes 
to the notebook with the following content:
-   'My first note.'
-   'My second note.'
