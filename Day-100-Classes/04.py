...
Modify the behavior of the append() method so that only objects 
of str type an be added to the list. Replace all uppercase letters 
with lowercase before adding the object to the list. If you try to add 
a different type of object raise TypeError with message:
