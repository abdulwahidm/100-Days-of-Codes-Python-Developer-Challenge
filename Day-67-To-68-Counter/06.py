...
Using the built-in re module split the given text into words/tokens. Standardize the words (all lowercase). Then create a Counter object that allows you to determine the three most common words in the text. In response, print these words with the number of occurrences.
