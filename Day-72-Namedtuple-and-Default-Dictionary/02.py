...
Using the dict.setdefault() method set the default value for the 'source' key to 'NYSE'. 
Then print the quotations dictionary to the console.

Try again to set the default value for the key 'source' to 'LSE' this time. 
Then print the dictionary quotations and the value for the key 'source' of 
quotations dictionary as shown below to the console.
