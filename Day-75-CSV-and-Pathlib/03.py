"""
Using the built in pathlib module check if the directory named reports 
exists in your working directory. If not, create this directory. 
Then list all files/directories in your working directory sorted alphabetically.
