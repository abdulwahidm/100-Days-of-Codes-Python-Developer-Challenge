...
Using the pathlib built-in module check if the specified file exists. If not, create it in the standard way (statement with open...) and write into it the following text:
Open,High,Low,Close
