...
and assign it to the paths variable (try to automate it). 
Then create these directories.

In response, print all directories in the eval/media/music 
directory sorted alphabetically as shown below.
