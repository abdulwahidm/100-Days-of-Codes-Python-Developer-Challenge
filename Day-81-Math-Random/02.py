...
Using the built-in math module determine after how many years the amount invested 
in the model of continuous interest capitalization at an annual 
interest rate of 4% will at least double its value. 
Round the result to full years and print it to the console as shown below.
