"""
A point called centroid (variable centroid) is given:

centroid = (0.5, 0.5)
and 10 points with coordinates in the range [0, 1):
points = [(rand(), rand()) for i in range(10)]

Using the built-in math module calculate the distance of each point 
from the points list to the centroid. Then print the index of the closest point 
to the centroid with the distance to the centroid as shown below.
