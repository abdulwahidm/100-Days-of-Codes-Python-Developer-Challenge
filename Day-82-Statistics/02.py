...
Using the built-in statistics module calculate the mean value and standard deviation of the given data. 
Then create a NormalDist object with the calculated parameters and generate a 10-element sample 
from the normal distribution (round the values ​​to three decimal places) and assign to the result list.
