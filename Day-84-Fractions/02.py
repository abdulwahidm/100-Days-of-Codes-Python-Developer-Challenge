...
calculate the cube
using the built-in math module calculate the square root of the fraction 
(the math.sqrt() function will return a float object)

using the built-in math module calculate the square root of the fraction 
(return the result as a fractions.Fraction object).
