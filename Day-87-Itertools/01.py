...
Using the built-in itertools module and the chain class create an iterator 
to iterate through all company names in the stocks_us and stocks_de lists and 
