...
Using the built-in itertools module and the filterfalse class create an 
iterator to iterate through the closing prices from this dictionary (the Close key) 
that are less than 1500 and assign to the variable results.
