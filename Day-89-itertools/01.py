...
In case of an error in the data, the value None is sent. 
Create an iterator to iterate sequentially over both stream1 and stream2. 
If None is encountered in the data stream further 
values ​​in this stream are ignored (only in a single stream). 
Assign iterator to the results variable.
