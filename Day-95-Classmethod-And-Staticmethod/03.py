"""Complete the implementation of the Book class. In the __init__() method, 
set the bare attributes of the instance with names:
-   title
-   author
-   book_id
...
(use the @staticmethod decorator) called get_id(),
