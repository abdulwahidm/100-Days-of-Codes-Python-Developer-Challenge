...
Next, override the __init__() method so that the Car class 
in the constructor takes four arguments:
-   brand
-   color
-   year
-   horsepower
...
In response, print the value of the __dict__ attribute of the vehicle 
and car instances.
