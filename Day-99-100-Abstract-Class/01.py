...
that implements the calculate_tax() method that calculates 
the tax value according to the rule:
-   up to the amount of 80,000 -> 17% tax rate
-   everything above 80,000 -> 32% tax rate

Then create two instances of WorkerTaxPayer named worker1 
and worker2 and salaries of 70,000 and 95,000 respectively. 
In response, by calling calculate_tax() 
print the calculated tax for both instances to the console.
