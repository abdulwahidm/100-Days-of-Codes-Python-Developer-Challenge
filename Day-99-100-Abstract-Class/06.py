"""Implement a class named Client which has a class attribute 
named all_clients (as a list). Then the __init__() method 
sets two instance attributes (no validation):
-   name
-   email
...
[
    ...
    Client(name='Donald', email='sales@yahoo.com'), 
    Client(name='Mike', email='sales-contact@yahoo.com'
]
"""
